...
import { IconVariable, IconSettings, IconRun, IconFolder, IconDatabase, IconWorld, IconHome, IconFileCode, IconGitBranch } from '@tabler/icons';
  ...
  const getTabInfo = (type, tabName) => {
    switch (type) {
      ...
      case 'git-ui': {
        return (
          <>
            <IconGitBranch size={14} strokeWidth={1.5} className="special-tab-icon flex-shrink-0" style={{ color: '#e6a817' }} />
